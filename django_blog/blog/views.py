...
#-----------
# Implementing CRUD operations for Blog Post using class-based views
#-----------
...
#-----------
# Implementing CRUD operations for Blog Post Comments using class-based views
#-----------

#-------- CommentCreateView: For creating a comment on a post
class CommentCreateView(LoginRequiredMixin, CreateView):
    ...
    def get_success_url(self):
        return reverse('post-detail', args=[self.post.pk])      # redirect back to the post detail


#------- CommentUpdateView: For editing a comment (only author)
...
#------CommentDeleteView: For deleting a comment (only author)
